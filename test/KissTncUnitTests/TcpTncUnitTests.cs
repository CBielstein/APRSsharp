...
public class TcpTNCUnitTests
{
    ...
    {
        var mockConn = GetMockTcpConnection();
        using TcpTNC tnc = new TcpTNC(mockConn.Object, 0);
        tnc.SetTncPort(0);
    ...
    {
        var mockConn = GetMockTcpConnection();
        using TcpTNC tnc = new TcpTNC(mockConn.Object, 5);
        tnc.SetTncPort(5);
    ...
    private static Mock<ITcpConnection> GetMockTcpConnection()
    {
